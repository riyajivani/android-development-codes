...
public class AsynkTaskActivity extends AppCompatActivity {
    ...
    private class MyAsynkTaskRunner extends AsyncTask<String,String,String>
    {
        ...
        {
            progressDialog = ProgressDialog.show(AsynkTaskActivity.this,"progress dialouge ","wait for "+takeTime.getText().toString()+" seconds");
        }
